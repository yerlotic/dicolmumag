...
#define ADVANCED_SETTINGS_Q "\"Расширенные настройки\""
        ...
        APP_STRING(AS_TEXT_FILL_AREA, "Масштабировать по меньшей стороне"),
        APP_STRING(AS_TEXT_NOT_FILL_AREA, "Масштабировать по большей стороне"),
        ...
        APP_STRING(AS_TEXT_BEST_FIT_EXPL, "Эта настройка включает прилипание каждой следующей картинки к краям предыдущей по убыванию длины/ширины. Часто строит вертикальные столбы с пустым местом по бокам"),
...
#define ADVANCED_SETTINGS_Q "\"Advanced Settings\""
        ...
        APP_STRING(AS_TEXT_FILL_AREA, "Resize by a smaller side"),
        APP_STRING(AS_TEXT_NOT_FILL_AREA, "Resize by a bigger side"),
        ...
        APP_STRING(AS_TEXT_BEST_FIT_EXPL, "This option makes it so every new image could only be stacked on the bottom of a previous image if new image's width is less than or equal to the previous\nLong story short, it often makes long strips of images with empty space on the sides"),
